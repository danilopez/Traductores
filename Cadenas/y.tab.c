...
{
       0,     0,     3,     4,    10,    15,    19,    23,    27,    29
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      12,     0,    -1,    -1,    12,     6,     3,    13,    10,    -1,
      12,     4,    13,    10,    -1,    12,     1,    10,    -1,    13,
       8,    13,    -1,    13,     9,     5,    -1,     7,    -1,     6,
      -1
};
...
{
  "$end", "error", "$undefined", "ASIG", "PRINT", "NUM", "ID", "CAD",
  "'+'", "'-'", "';'", "$accept", "prog", "cadena", 0
};
#endif
...
{
       2,     3,     7,     8,     4,     6,     5,    11,    12,    13,
      11,    12,    17,    14,    15,    10,    16
};
...
/* Line 1806 of yacc.c  */
#line 39 "cadenasPlantilla.y"
    {strcpy(((yyvsp[(2) - (5)].nodo)->texto),(yyvsp[(4) - (5)].texto));}
    break;

  case 4:

/* Line 1806 of yacc.c  */
#line 40 "cadenasPlantilla.y"
    {printf("%s\n",(yyvsp[(3) - (4)].texto));}
    break;
...
/* Line 1806 of yacc.c  */
#line 43 "cadenasPlantilla.y"
    {sprintf((yyval.texto),"%s%s",(yyvsp[(1) - (3)].texto),(yyvsp[(3) - (3)].texto));}
    break;

  case 7:

/* Line 1806 of yacc.c  */
#line 44 "cadenasPlantilla.y"
    {
										int lenCad = strlen((yyvsp[(1) - (3)].texto));
										if ((yyvsp[(3) - (3)].numero) > 0) {
											if (lenCad > (yyvsp[(3) - (3)].numero)) {
												(yyvsp[(1) - (3)].texto)[lenCad - (yyvsp[(3) - (3)].numero)] = '\0';
												strcpy((yyval.texto),(yyvsp[(1) - (3)].texto));
											} else {
												// ERROR
											...
											if (lenCad > -(yyvsp[(3) - (3)].numero)) {
												strcpy((yyval.texto),(yyvsp[(1) - (3)].texto)-(yyvsp[(3) - (3)].numero));
											} else {
												// ERROR
												printf("La longitud de la cadena es menor que el numero.\n");
												(yyval.texto)[0] = '\0';
...
/* Line 1806 of yacc.c  */
#line 66 "cadenasPlantilla.y"
    {strcpy((yyval.texto),(yyvsp[(1) - (1)].texto));}
    break;

  case 9:

/* Line 1806 of yacc.c  */
#line 67 "cadenasPlantilla.y"
    {strcpy((yyval.texto),(yyvsp[(1) - (1)].nodo)->texto);}
    break;
